          ...
          <div className="flex flex-col lg:flex-row gap-8 sm:gap-12">
            ...
            <div className="lg:max-w-md text-left">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group relative inline-flex items-center justify-center gap-4 sm:gap-6 bg-black text-white rounded-full font-bold transition-all duration-200 hover:bg-gray-800 hover:shadow-xl hover:shadow-blue-200 px-10 sm:px-12 py-3 sm:py-4 text-sm sm:text-base min-h-[48px] mb-6 lg:mb-0"
              >
